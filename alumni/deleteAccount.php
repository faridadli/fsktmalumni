...
<body>
    ...
    include("../db.php");
    $id = $_SESSION['id'];
    $del = "DELETE FROM `alumni` WHERE id=$id";
    ...
    if (!$con->query($del)) {
        ...
        exit;
		 ...
		 echo '<center><div id=\'card\' class="animated fadeIn">
						  ...
						  <div id=\'lower-side\'>
							<p id=\'message\'>
							  Please come back later when you are ready! Take care :)<br><br>
							  <small>Redirecting you back<span id="loading-dots"></span><br>or <a href="../index.php">click here</a></small>
							</p>
						  </div>
						</div></center>
						<script>
        ...
        header('refresh:6;Location:.../index.html');
        exit;
    }
    ?>
