...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $id = $_SESSION['id'];
        $priv_contact = $_POST['contactprivacy'];
        $priv_dob = $_POST['dobprivacy'];
        $priv_status = $_POST['statusprivacy'];

        $update_privacy = "UPDATE `alumni_profile` SET `privacy_contact`=$priv_contact, `privacy_dob`=$priv_dob, `privacy_status`=$priv_status WHERE alumni_id=$id";

        $complete_update = $con->query($update_privacy);
